  ...
  ["208"],
  {
      ...
      !(function () {
        ...
        let a = function (e) {
            let t = window.getComputedStyle(e, null),
              a = t.getPropertyValue("position"),
              n = t.getPropertyValue("overflow"),
              i = t.getPropertyValue("display");
            ((a && "static" !== a) || (e.style.position = "relative"),
          ...
          n = function (e) {
            ...
            for (let n in a)
              t.getPropertyValue(n) !== a[n] && (e.style[n] = a[n]);
          },
          i = function (e) {
            let t = e.parentNode;
            (a(t),
          ...
          o = function (e) {
            ...
            for (let a = 0; a < e.length; a++) {
              if (!e[a].nodeName) continue;
              let n = e[a].nodeName.toLowerCase();
              if ("img" === n) {
                if (t) continue;
                e[a].complete
                  ? i(e[a])
                ...
                "video" === n
                  ? e[a].readyState > 0
                    ? i(e[a])
                    : e[a].addEventListener("loadedmetadata", function () {
                        i(this);
                      })
                  : i(e[a]);
            }
      ...
      window.tram = (function (e) {
        ...
        var l,
          ...
          S = function (e) {
            ...
            for (t = 0; t < R.length; t++)
              if ((a = R[t] + n) in h.style) return { dom: a, css: N[t] + e };
          },
          M = (t.support = {
        ...
        var w = (t.frame =
          ...
          U = (t.now =
            (r =
              (c = p.performance) &&
              (c.now || c.webkitNow || c.msNow || c.mozNow)) && M.bind
              ? r.bind(c)
              : Date.now ||
                function () {
                  return +new Date();
          ...
          V = s(function (t) {
            ...
            function f(e, t, n) {
              ...
              for (i in e)
                ((d = e[i]),
                  i in Y
                    ? (r.transform || (r.transform = {}), (r.transform[i] = d))
                    : (T.test(i) &&
                        (i = i.replace(/[A-Z]/g, function (e) {
                          return "-" + e.toLowerCase();
                        })),
                      i in z ? (r[i] = d) : (l || (l = {}), (l[i] = d))));
              for (i in r) {
            ...
            ((t.init = function (t) {
              ...
              M.backface &&
                W.hideBackface &&
                Q(this.el, M.backface.css, "hidden");
            }),
              y("add", a),
              y("start", n),
              y("wait", function (e) {
          ...
          D = s(function (t) {
            function o() {
              var e,
                ...
                n = c.length;
              if (n)
                for (w(o), t = U(), e = n; e--; ) (a = c[e]) && a.render(t);
            }
                ...
                if (a < this.duration) {
                  ...
                  return (
                    (t = this.startRGB
                      ...
                      : Math.round((this.begin + d * this.change) * r) / r),
        ...
        (n.debounce = function (e, t, a) {
          var i,
            ...
            r = function () {
              ...
              s < t
                ? (i = setTimeout(r, t - s))
                : ((i = null), a || ((c = e.apply(d, o)), (d = o = null)));
            };
          return function () {
    ...
    9461: function (e, t, a) {
      ...
      n.define(
        ...
        (e.exports = function (e) {
          ...
          function f() {
            var e = d.children(".webflow-the-og-badge"),
    ...
    5134: function (e, t, a) {
      ...
      var o = window.jQuery,
        ...
        l = ".w-ix";
      ((d.triggers = {}),
        (d.types = { INTRO: "w-ix-intro" + l, OUTRO: "w-ix-outro" + l }),
        o.extend(d.triggers, {
          reset: function (e, t) {
    ...
    6524: function (e, t) {
      "use strict";
      function a(e, t, a, n, i, o, d, l, c, r, s, f, u) {
        return function (p) {
          e(p);
          var E = p.form,
            I = {
      ...
      n.define(
        ...
        (e.exports = function (e, t) {
                ...
                p.on(
                  ...
                  function () {
                    i(
                      ...
                      o,
                      (e) => {
                        ((r.turnstileToken = e), h(r), N(l, !1));
                      },
                      () => {
                        (h(r), r.btn && r.btn.prop("disabled", !0), N(l, !1));
                      },
                    );
                  },
                )));
          ...
          function w(a) {
            ...
            ((o["b_" + c + "_" + (r = l.substring(r, l.indexOf("&", r)))] = ""),
              e
      ...
      n.define(
        ...
        (e.exports = function (e, t) {
            ...
            r.preview =
              function () {
                ((l = E && n.env("design")),
                  (c = n.env("editor")),
                  (a = e(document.body)),
                  (d = u.find(I)).length && (d.each(h), L(), n.resize.on(_)));
              }),
            (r.destroy = function () {
          ...
          function V(t, a) {
            ...
            if ((!n.open || i || l || D(n, !0), n.container.length)) {
              var o,
                d =
                  ("none" === (o = n.container.css(B)) && (o = ""),
                  function (t, a) {
                    ((a = e(a)).css(B, ""), "none" === a.css(B) && a.css(B, o));
                  });
    ...
    3946: function (e, t, a) {
      ...
      let o = a(7087),
        ...
        { reifyState: N } = d.IX2VanillaUtils,
    ...
    1970: function (e, t, a) {
      ...
      function K(e) {
        (A({ store: e, select: ({ ixRequest: e }) => e.preview, onChange: J }),
          A({
            store: e,
            select: ({ ixRequest: e }) => e.playback,
            onChange: et,
          }),
          A({ store: e, select: ({ ixRequest: e }) => e.stop, onChange: ea }),
          A({ store: e, select: ({ ixRequest: e }) => e.clear, onChange: en }));
      }
      function J({ rawData: e, defer: t }, a) {
        let n = () => {
          (ei({ store: a, rawData: e, allowEvents: !0 }), ee());
        };
        t ? setTimeout(n, 0) : n();
      }
      function ee() {
      ...
      function et(e, t) {
        ...
        if (
          (ei({ store: t, rawData: s, allowEvents: d, testManual: c }),
          (n && a === p.ActionTypeConsts.GENERAL_START_ACTION) || O(a))
        ) {
          (eE({ store: t, actionListId: n }),
      ...
      function ea({ actionListId: e }, t) {
        (e ? eE({ store: t, actionListId: e }) : ep({ store: t }), eo(t));
      }
      function en(e, t) {
        (eo(t), U({ store: t, elementApi: T }));
      }
      function ei({ store: e, rawData: t, allowEvents: a, testManual: n }) {
                    ...
                    (0, f.default)(s, (e, n) => {
                      ...
                      (Q(f, c.mediaQueryKeys) ||
                        ...
                        (l.actionTypeId ===
                          ...
                          O(l.actionTypeId)) &&
                          eu({ store: t, actionListId: u, eventId: s }));
                    });
                    let E = (e) => {
      ...
      let er = (e, t) => (0, c.default)((0, s.default)(e, t), r.default),
        es = (e, t) => {
          (0, f.default)(e, (e, a) => {
            e.forEach((e, n) => {
              t(e, a, a + v + n);
      ...
      function eI({
        ...
        let g = s.hasBoundaryNodes && a ? T.getClosestElement(a, L) : null,
          b = V(m),
          v = !1;
        return (
          m.forEach((d, r) => {
            ...
            E &&
              N({
                ...
                let E = p ? z(f)?.(s, d) : null,
                  I = p ? Y(f)(s, d) : null;
                v = !0;
                let m = B({ element: s, actionItem: d }),
                  g = M({ element: s, actionItem: d, elementApi: T }, E);
                eT({
                  store: e,
                  element: s,
                  actionItem: d,
      ...
      function eT(e) {
        ...
        (A({ store: a, select: ({ ixInstances: e }) => e[u], onChange: eg }),
      ...
      function eg(e, t) {
        let {
          ...
          { events: L } = O,
          { mediaQueries: R = O.mediaQueryKeys } = L && L[f] ? L[f] : {};
        if (D(R, v.mediaQueryKey) && (n || a || i)) {
          if (r || (c === h && i)) {
            t.dispatch((0, I.elementStateChanged)(o, l, r, d));
            let { ixElements: e } = t.getState(),
              { ref: a, refType: n, refState: i } = e[o] || {},
              s = i && i[l];
            (n === _ || j(l)) && w(a, i, s, f, d, m, T, c, b);
          }
          if (i) {
            if (y) {
              let e = eI({
    ...
    8955: function (e, t, a) {
      ...
      let {
        ...
        { COLON_DELIMITER: P } = l.IX2EngineConstants,
        { getNamespacedParameterId: D } = s.IX2VanillaUtils,
        G = (e) => (t) => !!("object" == typeof t && e(t)) || t,
        X = G(({ element: e, nativeEvent: t }) => e === t.target),
        ...
        z = ({ store: e, event: t, element: a, eventStateKey: n }, i) => {
          let { action: d, id: l } = t,
            { actionListId: r, autoStopEventId: s } = d.config,
            f = H(e, s);
          return (
            f &&
              (0, c.stopActionGroup)({
        ...
        eo = (e) => {
          let {
            ...
            { clientWidth: n, clientHeight: i } = ea(),
        ...
        ed = (e) => (t, a) => {
          let { type: n } = t.nativeEvent,
            i = -1 !== [F, x].indexOf(n) ? n === F : a.isActive,
            o = { ...a, isActive: i };
          return ((!a || o.isActive !== a.isActive) && e(t, o)) || o;
        },
        el = (e) => (t, a) => {
          let n = { elementHovered: ei(t) };
          return (
        ...
        ec =
          ...
          (t, a = {}) => {
            let n,
              i,
              { stiffScrollTop: o, scrollHeight: d, innerHeight: l } = ea(),
              {
        ...
        ef = (e = !0) => ({
          ...
          handler: Y(
            e ? Q : X,
            ed((e, t) => (t.isActive ? Z.handler(e, t) : t)),
          ),
        }),
        eu = (e = !0) => ({
          ...q,
          handler: Y(
            e ? Q : X,
            ed((e, t) => (t.isActive ? t : Z.handler(e, t))),
          ),
        }),
        ep = {
          ...ee,
        ...
        eE = {
          ...
          [v]: ef(),
          [L]: eu(),
          [V]: { types: "ecommerce-cart-open", handler: Y(Q, z) },
          [U]: { types: "ecommerce-cart-close", handler: Y(Q, z) },
          [u]: {
            types: "click",
            handler: Y(
              Q,
              ...
              switch (d) {
                ...
                default: {
                  ...
                  let a = t.getBoundingClientRect(),
                    { left: o, top: d, width: l, height: c } = a;
                  if (!e && !er({ left: p, top: E }, a)) break;
                  ((O = !0), (g = y ? (p - o) / l : (E - d) / c));
                }
              }
              return (
                m && (g > 0.95 || g < 0.05) && (g = Math.round(g)),
                (d !== l.EventBasedOn.ELEMENT || O || O !== o.elementHovered) &&
                  ((g = f ? 1 - g : g),
    ...
    8686: function (e, t, a) {
      ...
      let d = (n = a(1361)) && n.__esModule ? n : { default: n },
        l = (0, d.default)(0.25, 0.1, 0.25, 1),
        c = (0, d.default)(0.42, 0, 1, 1),
        r = (0, d.default)(0, 0, 0.58, 1),
    ...
    4124: function (e, t, a) {
      ...
      let {
        ...
        ec = (e) => e.trim(),
        er = Object.freeze({ [en]: C, [ei]: w, [eo]: U }),
        es = Object.freeze({
      ...
      function ey({ events: e, actionLists: t, site: a } = {}) {
        let n = (0, d.default)(
            e,
            (e, t) => {
              let { eventTypeId: a } = t;
      ...
      let em = (e, t) => e === t;
      function eg({ store: e, select: t, onChange: a, comparator: n = em }) {
      ...
      function eO({
        ...
        if (
          (N
            ? ((o = R.limitAffectedElements), (d = S), (l = f(R)))
            : (d = l = f({ id: b, selector: v, selectorGuids: L })),
          t && h)
        ) {
          let e = a && (l || !0 === h) ? [a] : u(S);
          if (l) {
            if (h === F) return u(l).filter((t) => e.some((e) => y(t, e)));
            if (h === V) return u(l).filter((t) => e.some((e) => y(e, t)));
            if (h === k) return u(l).filter((t) => e.some((e) => m(e, t)));
          }
          return e;
        }
      ...
      function eR(e, t = {}, a = {}, n, i) {
        ...
        switch (n.actionTypeId) {
              ...
              heightValue:
                n.config.heightUnit === D
                  ? eL.test(l)
                    ? parseFloat(l)
                    : parseFloat(a.height)
                  : (0, o.default)(parseFloat(l), parseFloat(a.height)),
            };
          }
          case en:
          case ei:
          ...
          case ed:
            return { value: (0, o.default)(d(e, x), a.display) };
          case el:
        ...
        switch (t.actionTypeId) {
          ...
          case ea: {
            let { getStyle: n, setStyle: i, getProperty: o } = a,
              { widthUnit: d, heightUnit: l } = t.config,
        ...
        switch (c) {
          case Q:
            ...
            let y = ex
                ...
                .join(" "),
              { setStyle: R } = T;
            (eG(s, E.TRANSFORM_PREFIXED, T),
              R(s, E.TRANSFORM_PREFIXED, y),
              (function (
                { actionTypeId: e },
              ...
              })(I, u) && R(s, E.TRANSFORM_STYLE_PREFIXED, _));
            return;
          case j:
            return (function (e, t, a, n, i, o) {
              ...
              switch (n.actionTypeId) {
                case ea: {
                  ...
                  (void 0 !== d &&
                    (t === D && (t = "px"), eG(e, M, o), l(e, M, d + t)),
                    void 0 !== c &&
                      (i === D && (i = "px"), eG(e, A, o), l(e, A, c + i)));
                  break;
                }
                case ee:
                  var c = n.config;
          ...
          case H:
            var C = e,
              ...
              U = l;
            let { setStyle: V } = U;
            if (w.actionTypeId === ed) {
              let { value: e } = w.config;
              V(C, x, e === h && E.IS_BROWSER_ENV ? E.FLEX_PREFIXED : e);
            }
            return;
          case z: {
      ...
      function eG(e, t, a) {
        ...
        let l = d.split(G).map(ec);
        -1 === l.indexOf(n) && o(e, P, l.concat(n).join(G));
      }
      function eX(e, t, a) {
        if (!E.IS_BROWSER_ENV) return;
        let n = es[t];
      ...
      function eH({ actionGroup: e, event: t, elementApi: a }) {
        ...
        n.forEach((e) => {
          ...
          ((n = (0, p.isPluginType)(i)
            ...
            : ez({ effect: eY, actionTypeId: i, elementApi: a })),
      ...
      function ej(e, t, a) {
        ...
        i(e, P) && ez({ effect: eX, actionTypeId: o, elementApi: a })(e);
      }
      let ez =
          ...
          switch (t.type) {
            ...
            case g: {
              let {
                ...
                r = e;
              return (
                (0, o.getIn)(r, [a, n]) !== n && (r = L(r, n, l, a, d)),
                _(r, a, c, i, d)
              );
            }
            case b: {
      ...
      Webflow.require("ix2").init({
        events: {
          e: {
            ...
            target: {
              selector: ".inner-hero-one-wrapper",
              originalId:
                "69144c948596354fc062a030|92e5da75-0c42-4302-5e42-a9d848415d03",
              appliesTo: "CLASS",
            },
            targets: [
              {
          ...
          "e-3": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "69144c948596354fc062a030|92e5da75-0c42-4302-5e42-a9d848415d11",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-5": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "69144c948596354fc062a030|92e5da75-0c42-4302-5e42-a9d848415d45",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-7": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "69144c948596354fc062a030|92e5da75-0c42-4302-5e42-a9d848415dcf",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-11": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "06721b9b-0089-23d1-25f7-294ab6389610",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-13": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "06721b9b-0089-23d1-25f7-294ab638962d",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-23": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "691447f4d1d5c19c39252790|b552b305-d3fb-8062-6970-a4b84c9a5a42",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-27": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "691447f4d1d5c19c39252790|4b270de4-16d9-8653-8cbe-37f1576d916e",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-31": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              selector: ".counter-numbers-wrap",
              originalId:
                "691447f4d1d5c19c39252790|3c14e600-4780-6c7b-757f-4a62816c06af",
              appliesTo: "CLASS",
            },
            targets: [
              {
          ...
          "e-39": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "691447f4d1d5c19c39252790|12241ccb-20f0-4bd9-43ea-0929b144f85a",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-44": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "691447f4d1d5c19c39252790|12241ccb-20f0-4bd9-43ea-0929b144f859",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-47": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "691447f4d1d5c19c39252790|1ea1db9b-0e8c-5dc8-5365-042255090dee",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-49": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "691447f4d1d5c19c39252790|63d7ac6c-00d8-0413-07d8-4b199b6f186a",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-51": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "691447f4d1d5c19c39252790|d27bada2-8a3f-0499-5600-115390f8cf4f",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-53": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "691447f4d1d5c19c39252790|f7dd70ca-99df-a0ae-68cd-f1ac91f1c966",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-55": {
            ...
            mediaQueries: ["main"],
            target: {
              id: "691447f4d1d5c19c39252790|856db990-ffb3-68b7-40b5-32f368d093cc",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-58": {
            ...
            target: {
              selector: ".blog-card",
              originalId:
                "691447f4d1d5c19c39252790|395dd720-3314-c407-beb8-12cf7190bde1",
              appliesTo: "CLASS",
            },
            targets: [
              {
          ...
          "e-66": {
            ...
            mediaQueries: ["main", "medium"],
            target: {
              selector: ".projects-item-one",
              originalId:
                "691447f4d1d5c19c39252790|fec6fcf1-d0b3-d8f0-b552-75bb2524339a",
              appliesTo: "CLASS",
            },
            targets: [
              {
          ...
          "e-68": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "691447f4d1d5c19c39252790|b2019af1-d547-6b33-8b74-00e3a6591283",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-70": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "691447f4d1d5c19c39252790|094b742f-1f00-36f6-5cda-bcfc6e9962f7",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-72": {
            ...
            action: {
              ...
              actionTypeId: "SLIDE_EFFECT",
              instant: !1,
              config: { actionListId: "slideInRight", autoStopEventId: "e-73" },
            },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "691447f4d1d5c19c39252790|42a1e1e0-d63a-8f2f-83c7-8d0ec861b555",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-74": {
            ...
            action: {
              ...
              actionTypeId: "SLIDE_EFFECT",
              instant: !1,
              config: { actionListId: "slideInLeft", autoStopEventId: "e-75" },
            },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "691447f4d1d5c19c39252790|a6ea12df-e95a-19f4-5db6-13bd7c089e1d",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-76": {
            ...
            action: {
              ...
              actionTypeId: "SLIDE_EFFECT",
              instant: !1,
              config: { actionListId: "slideInRight", autoStopEventId: "e-77" },
            },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "691447f4d1d5c19c39252790|49bd6611-26a9-ca45-143b-32f157334319",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-78": {
            ...
            target: {
              ...
              originalId:
                "691448ed7f9b14f226451f88|953b1928-eb56-fcc2-b706-c6dde3651f78",
              appliesTo: "CLASS",
            },
            targets: [
              {
          ...
          "e-92": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "691448d58c7087933076fdb7|8aa3a13b-818a-9034-4d27-c2e348cba490",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-94": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "691448d58c7087933076fdb7|8aa3a13b-818a-9034-4d27-c2e348cba494",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-96": {
            ...
            action: {
              ...
              actionTypeId: "SLIDE_EFFECT",
              instant: !1,
              config: { actionListId: "slideInLeft", autoStopEventId: "e-97" },
            },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "691448d58c7087933076fdb7|8aa3a13b-818a-9034-4d27-c2e348cba4b3",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-98": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "691448d58c7087933076fdb7|8aa3a13b-818a-9034-4d27-c2e348cba4b7",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-100": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "691448d58c7087933076fdb7|8aa3a13b-818a-9034-4d27-c2e348cba4d6",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-102": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "691448d58c7087933076fdb7|8aa3a13b-818a-9034-4d27-c2e348cba4da",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-104": {
            ...
            action: {
              ...
              actionTypeId: "SLIDE_EFFECT",
              instant: !1,
              config: { actionListId: "slideInLeft", autoStopEventId: "e-105" },
            },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "691448d58c7087933076fdb7|a30572b6-c7d2-2669-a897-efb4ba71b3c3",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-106": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "691448d58c7087933076fdb7|a30572b6-c7d2-2669-a897-efb4ba71b3c7",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-108": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "691448d58c7087933076fdb7|56d1b64f-5bf7-26ec-d7be-f56355130d9a",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-110": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "691448d58c7087933076fdb7|56d1b64f-5bf7-26ec-d7be-f56355130d9e",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-128": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "69144814a315153283850ff2|fb8bfa0c-5c80-98e6-eaee-18df6550915e",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e
{
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "8132fdb3-b503-9ee2-fd7d-e21db97f578c",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-522": {
            ...
            mediaQueries: ["main"],
            target: {
              id: "6914516c8596354fc0641b67|0153ad6e-b591-213b-653a-e7675d8b76df",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-523": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "69144814a315153283850ff2|771b6033-5e46-00b5-77c3-18b2c78f34f2",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-525": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "69144814a315153283850ff2|012e833d-25a5-0dfa-48d2-9da0a16376a7",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-527": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "69144814a315153283850ff2|256bab39-19d7-1714-a634-7915f5a23420",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-529": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "69144814a315153283850ff2|48a5f39a-92ba-1c5b-ad6a-18c85d8f8871",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
        ...
        actionLists: {
                ...
                actionItems: [
                  {
                    ...
                    config: {
                      ...
                      target: {
                        ...
                        selectorGuids: ["fd7f56f5-a811-7ec4-e1d3-60cd270bbb29"],
                      },
                      value: "none",
                    },
                  },
                  {
                    ...
                    config: {
                      ...
                      target: {
                        selector: ".nav-link",
                        selectorGuids: ["22e0c51b-f61e-fdcc-ec36-6b94d5b38a52"],
                      },
                      widthValue: 100,
                      heightValue: 0,
                      widthUnit: "%",
                  ...
                  },
                  {
                    ...
                    config: {
                      ...
                      target: {
                        ...
                        selector: ".divder-line",
                        selectorGuids: ["e4c69616-3ae5-d8e8-a507-515d0ff76a65"],
                      },
                      widthValue: 60,
                      widthUnit: "px",
                      heightUnit: "PX",
                  ...
                  },
                  {
                    ...
                    config: {
                      ...
                      target: {
                        ...
                        selector: ".menu-text",
                        selectorGuids: ["1ffdf3d1-8e0e-1be4-7743-f64aa187b90f"],
                      },
                      yValue: 0,
                      xUnit: "PX",
                      yUnit: "%",
                  ...
                  },
                  {
                    ...
                    config: {
                      ...
                      target: {
                        useEventTarget: "CHILDREN",
                        selector: ".nav-icon",
                        selectorGuids: ["48d03e78-7658-2aa3-1aca-3bce73a7ab95"],
                      },
                      globalSwatchId: "",
                      rValue: 0,
                      bValue: 0,
                ...
                actionItems: [
                  {
                    ...
                    config: {
                      ...
                      target: {
                        useEventTarget: "CHILDREN",
                        selector: ".nav-button-icon-wrap",
                        selectorGuids: ["a515143c-7d3c-156f-6536-296694cab456"],
                      },
                      zValue: 0,
                      xUnit: "DEG",
                      yUnit: "DEG",
          ...
          "a-6": {
            ...
            useFirstGroupAsInitialState: !1,
            createdOn: 0x1990f970492,
          },
          "a-7": {
            id: "a-7",
            title: "Hero Slide Animation",
            actionItemGroups: [
              {
                actionItems: [
                  {
                    ...
                    config: {
                      ...
                      duration: 500,
                      target: {
                        selector: ".hero-slide-image",
                        selectorGuids: ["baae76f8-7c7b-8981-bd9b-ffdbbbb4b8d1"],
                      },
                      widthValue: 100,
                      widthUnit: "%",
                      heightUnit: "PX",
                  ...
                  },
                  {
                    ...
                    config: {
                      ...
                      duration: 500,
                      target: {
                        selector: ".hero-image-slide-border-up.one",
                        selectorGuids: [
                          "25bd13f5-f8c5-e757-c6f5-a8cfdc151f55",
                          "d2aec319-c0d4-d156-1f6e-628982ebebf9",
                        ],
                      },
                      widthValue: 0,
                      widthUnit: "%",
                  ...
                  },
                  {
                    ...
                    config: {
                      ...
                      duration: 500,
                      target: {
                        selector: ".hero-image-slide-border-right.one",
                        selectorGuids: [
                          "2892f1e3-97da-261d-0be5-1dad1934be93",
                          "a93c44b1-733a-0b1d-546f-7914ce5ea685",
                        ],
                      },
                      heightValue: 0,
                      widthUnit: "PX",
                  ...
                  },
                  {
                    ...
                    config: {
                      ...
                      duration: 500,
                      target: {
                        selector: ".hero-image-slide-border-down.one",
                        selectorGuids: [
                          "6a8d7ec1-7061-ee61-5c6e-a8e9d6f3843a",
                          "c56850a1-c5d7-7b45-8690-a4e83b504a4d",
                        ],
                      },
                      widthValue: 0,
                      widthUnit: "%",
                  ...
                  },
                  {
                    ...
                    config: {
                      ...
                      duration: 500,
                      target: {
                        selector: ".hero-image-slide-border-left.one",
                        selectorGuids: [
                          "9f73a694-8f3a-d8e0-fbb1-c48dbcfa516a",
                          "c5a5b524-d21a-f4d0-ead0-b223a8aa8cc6",
                        ],
                      },
                      heightValue: 0,
                      widthUnit: "PX",
                  ...
                  },
                  {
                    ...
                    config: {
                      ...
                      duration: 500,
                      target: {
                        selector: ".hero-image-slide-border-up.two",
                        selectorGuids: [
                          "25bd13f5-f8c5-e757-c6f5-a8cfdc151f55",
                          "872b41c6-00dd-1559-2f80-eb69d3e02303",
                        ],
                      },
                      widthValue: 0,
                      widthUnit: "%",
                  ...
                  },
                  {
                    ...
                    config: {
                      ...
                      duration: 500,
                      target: {
                        selector: ".hero-image-slide-border-right.two",
                        selectorGuids: [
                          "2892f1e3-97da-261d-0be5-1dad1934be93",
                          "e4efd484-549b-4cab-2c8e-b410b82b0c68",
                        ],
                      },
                      heightValue: 0,
                      widthUnit: "PX",
                  ...
                  },
                  {
                    ...
                    config: {
                      ...
                      duration: 500,
                      target: {
                        selector: ".hero-image-slide-border-down.two",
                        selectorGuids: [
                          "6a8d7ec1-7061-ee61-5c6e-a8e9d6f3843a",
                          "82416795-1f0e-44b8-a88c-88bfc3cdcbc6",
                        ],
                      },
                      widthValue: 0,
                      widthUnit: "%",
                  ...
                  },
                  {
                    ...
                    config: {
                      ...
                      duration: 500,
                      target: {
                        selector: ".hero-image-slide-border-left.two",
                        selectorGuids: [
                          "9f73a694-8f3a-d8e0-fbb1-c48dbcfa516a",
                          "d712bcf5-ed37-7dbd-26ef-76e94ddd5470",
                        ],
                      },
                      heightValue: 0,
                      widthUnit: "PX",
                  ...
                  },
                  {
                    ...
                    config: {
                      ...
                      duration: 500,
                      target: {
                        selector: ".hero-image-slide-border-up.three",
                        selectorGuids: [
                          "25bd13f5-f8c5-e757-c6f5-a8cfdc151f55",
                          "db6ab8b8-5d7f-232f-d15e-3fe8afaf2f54",
                        ],
                      },
                      widthValue: 0,
                      widthUnit: "%",
                  ...
                  },
                  {
                    ...
                    config: {
                      ...
                      duration: 500,
                      target: {
                        selector: ".hero-image-slide-border-right.three",
                        selectorGuids: [
                          "2892f1e3-97da-261d-0be5-1dad1934be93",
                          "494b2f10-b7ba-695e-8ca2-b03a0f9c68b7",
                        ],
                      },
                      heightValue: 0,
                      widthUnit: "PX",
                  ...
                  },
                  {
                    ...
                    config: {
                      ...
                      duration: 500,
                      target: {
                        selector: ".hero-image-slide-border-down.three",
                        selectorGuids: [
                          "6a8d7ec1-7061-ee61-5c6e-a8e9d6f3843a",
                          "4f4138ad-780c-3216-fca1-b2d68258919d",
                        ],
                      },
                      widthValue: 0,
                      widthUnit: "%",
                  ...
                  },
                  {
                    ...
                    config: {
                      ...
                      duration: 500,
                      target: {
                        selector: ".hero-image-slide-border-left.three",
                        selectorGuids: [
                          "9f73a694-8f3a-d8e0-fbb1-c48dbcfa516a",
                          "6399bd06-9903-c185-4f91-c91368a08410",
                        ],
                      },
                      heightValue: 0,
                      widthUnit: "px",
                ...
                actionItems: [
                  {
                    ...
                    config: {
                      ...
                      duration: 1e3,
                      target: {
                        selector: ".hero-slide-image.one",
                        selectorGuids: [
                          "baae76f8-7c7b-8981-bd9b-ffdbbbb4b8d1",
                          "aa2b0bca-479f-7d33-621b-5124102d12db",
                        ],
                      },
                      widthValue: 0,
                      widthUnit: "%",
                ...
                actionItems: [
                  {
                    ...
                    config: {
                      ...
                      target: {
                        useEventTarget: "CHILDREN",
                        selector: ".hero-slide-image.two",
                        selectorGuids: [
                          "baae76f8-7c7b-8981-bd9b-ffdbbbb4b8d1",
                          "ee3020da-15d4-e2ee-2135-1a94b21dc7f7",
                        ],
                      },
                      widthValue: 0,
                      widthUnit: "%",
                ...
                actionItems: [
                  {
                    ...
                    config: {
                      ...
                      target: {
                        useEventTarget: "CHILDREN",
                        selector: ".hero-slide-image.three",
                        selectorGuids: [
                          "baae76f8-7c7b-8981-bd9b-ffdbbbb4b8d1",
                          "9d96bf98-49bf-abec-124b-aa5c6ffba612",
                        ],
                      },
                      widthValue: 100,
                      widthUnit: "%",
          ...
          "a-8": {
                ...
                actionItems: [
                  {
                    ...
                    config: {
                      ...
                      duration: 12e3,
                      target: {
                        selector: ".hero-ticker-wrap",
                        selectorGuids: ["5d701067-995b-fa72-d967-f1429e16ff06"],
                      },
                      xValue: -100,
                      xUnit: "%",
                      yUnit: "PX",
            ...
            useFirstGroupAsInitialState: !1,
            createdOn: 0x19a8fef2327,
          },
          "a-9": {
            id: "a-9",
            title: "Hero Service Item Hover In",
            actionItemGroups: [
              {
                actionItems: [
                  {
                    ...
                    config: {
                      ...
                      target: {
                        useEventTarget: "CHILDREN",
                        selector: ".info-line",
                        selectorGuids: ["c8131cf6-1201-4599-d0cc-f0f150417614"],
                      },
                      widthValue: 0,
                      widthUnit: "%",
                      heightUnit: "PX",
            ...
            useFirstGroupAsInitialState: !0,
            createdOn: 0x19a8ffcc530,
          },
          "a-10": {
            id: "a-10",
            title: "Hero Service Item Hover  Out",
            actionItemGroups: [
              {
                actionItems: [
                  {
            ...
            useFirstGroupAsInitialState: !1,
            createdOn: 0x19a8ffdb0d6,
          },
          "a-13": {
            id: "a-13",
            title: "Counter Numbers Scroll Animation",
            actionItemGroups: [
              {
                actionItems: [
                  {
                    ...
                    config: {
                      ...
                      duration: 500,
                      target: {
                        selector: ".counter-number-wrap._01",
                        selectorGuids: [
                          "2ea7da2e-764f-018e-d336-123c2cf007e9",
                          "2ea7da2e-764f-018e-d336-123c2cf007ed",
                        ],
                      },
                      yValue: 0,
                      xUnit: "PX",
                  ...
                  },
                  {
                    ...
                    config: {
                      ...
                      duration: 500,
                      target: {
                        selector: ".counter-number-wrap._02",
                        selectorGuids: [
                          "2ea7da2e-764f-018e-d336-123c2cf007e9",
                          "2ea7da2e-764f-018e-d336-123c2cf007ee",
                        ],
                      },
                      yValue: 0,
                      xUnit: "PX",
                ...
                actionItems: [
                  {
                    ...
                    config: {
                      ...
                      target: {
                        useEventTarget: "CHILDREN",
                        selector: ".faq-single-details-wrap",
                        selectorGuids: ["0a32bdc9-9067-e0c3-f128-c6afeca520a2"],
                      },
                      widthValue: 100,
                      heightValue: 0,
                      widthUnit: "%",
                  ...
                  },
                  {
                    ...
                    config: {
                      ...
                      target: {
                        useEventTarget: "CHILDREN",
                        selector: ".pluse-div",
                        selectorGuids: ["0a32bdc9-9067-e0c3-f128-c6afeca5209b"],
                      },
                      globalSwatchId: "--_colors---dark",
                      rValue: 20,
                      bValue: 20,
                      gValue: 20,
                      aValue: 1,
                  ...
                  },
                  {
                    ...
                    config: {
                      ...
                      target: {
                        useEventTarget: "CHILDREN",
                        selector: ".minass-div",
                        selectorGuids: ["0a32bdc9-9067-e0c3-f128-c6afeca5209c"],
                      },
                      value: 1,
                      unit: "",
                    },
          ...
          "a-14": {
            ...
            useFirstGroupAsInitialState: !0,
            createdOn: 0x196f20b2da9,
          },
          "a-16": {
            id: "a-16",
            title: "Partner Items Scrolling",
                    ...
                    actionItems: [
                      {
                        ...
                        config: {
                          ...
                          target: {
                            useEventTarget: "CHILDREN",
                            selector: ".partner-item.three",
                            selectorGuids: [
                              "3d2146e3-533b-d45f-75bc-237693439a7e",
                              "9d7f7819-f6fa-18e0-2d1b-35a2522824ae",
                            ],
                          },
                          xValue: 85,
                          xUnit: "%",
                      ...
                      },
                      {
                        ...
                        config: {
                          ...
                          target: {
                            useEventTarget: "CHILDREN",
                            selector: ".partner-item.five",
                            selectorGuids: [
                              "3d2146e3-533b-d45f-75bc-237693439a7e",
                              "ebc213c0-51ed-db5c-d00b-d6aa0b836df5",
                            ],
                          },
                          xValue: -85,
                          xUnit: "%",
                      ...
                      },
                      {
                        ...
                        config: {
                          ...
                          target: {
                            useEventTarget: "CHILDREN",
                            selector: ".partner-item.two",
                            selectorGuids: [
                              "3d2146e3-533b-d45f-75bc-237693439a7e",
                              "7cb0a724-5159-13ed-41ed-149745a663d5",
                            ],
                          },
                          xValue: 170,
                          xUnit: "%",
                      ...
                      },
                      {
                        ...
                        config: {
                          ...
                          target: {
                            useEventTarget: "CHILDREN",
                            selector: ".partner-item.six",
                            selectorGuids: [
                              "3d2146e3-533b-d45f-75bc-237693439a7e",
                              "2ce101a8-6c57-01cf-0d99-fb59a3dfb5f1",
                            ],
                          },
                          xValue: -170,
                          xUnit: "%",
                      ...
                      },
                      {
                        ...
                        config: {
                          ...
                          target: {
                            useEventTarget: "CHILDREN",
                            selector: ".partner-item.one",
                            selectorGuids: [
                              "3d2146e3-533b-d45f-75bc-237693439a7e",
                              "849353b7-bea1-a23d-90fd-ccafd54b011b",
                            ],
                          },
                          xValue: 250,
                          xUnit: "%",
                      ...
                      },
                      {
                        ...
                        config: {
                          ...
                          target: {
                            useEventTarget: "CHILDREN",
                            selector: ".partner-item.seven",
                            selectorGuids: [
                              "3d2146e3-533b-d45f-75bc-237693439a7e",
                              "00fd1acd-9118-28fc-dd39-e2dad6d8c066",
                            ],
                          },
                          xValue: -250,
                          xUnit: "%",
                ...
                actionItems: [
                  {
                    ...
                    config: {
                      ...
                      target: {
                        ...
                        selectorGuids: ["903fb753-ef1f-f138-d909-a9fa1e236b84"],
                      },
                      xValue: 1,
                      yValue: 1,
                      locked: !0,
                  ...
                  },
                  {
                    ...
                    config: {
                      ...
                      target: {
                        useEventTarget: "CHILDREN",
                        selector: ".blog-card-button-wrap",
                        selectorGuids: ["8eb5cf17-e249-da11-ecea-a61234b5845b"],
                      },
                      xValue: 0,
                      yValue: 0,
                      locked: !0,
          ...
          "a-20": {
            ...
            useFirstGroupAsInitialState: !1,
            createdOn: 0x19aa9e3bb81,
          },
          "a-21": {
            id: "a-21",
            title: "Project Item Button Spinner",
            actionItemGroups: [
              {
                actionItems: [
                  {
                    ...
                    config: {
                      ...
                      duration: 0,
                      target: {
                        selector: ".button-text-wrap",
                        selectorGuids: ["99d3888b-e7af-131d-290a-5446b05d4a6a"],
                      },
                      zValue: 0,
                      xUnit: "DEG",
                      yUnit: "DEG",
                ...
                actionItems: [
                  {
                    ...
                    config: {
                      ...
                      target: {
                        useEventTarget: "CHILDREN",
                        selector: ".projects-item-image",
                        selectorGuids: ["ebc2343d-ef2c-7684-1a72-8b849ff70ed4"],
                      },
                      xValue: 1,
                      yValue: 1,
                      locked: !0,
                  ...
                  },
                  {
                    ...
                    config: {
                      ...
                      target: {
                        useEventTarget: "CHILDREN",
                        selector: ".projects-item-button-wrap",
                        selectorGuids: ["e6213d46-03a9-3961-819c-65ed27c29980"],
                      },
                      xValue: 0,
                      yValue: 0,
                      locked: !0,
          ...
          "a-23": {
            ...
            useFirstGroupAsInitialState: !1,
            createdOn: 0x19aaa60cfcd,
          },
          "a-24": {
            id: "a-24",
            title: "Contact Info Item Hover In",
            actionItemGroups: [
              {
                actionItems: [
                  {
                    ...
                    config: {
                      ...
                      target: {
                        useEventTarget: "CHILDREN",
                        selector: ".contact-info-item",
                        selectorGuids: ["5202fcd4-c85c-44e8-1e8a-8e2e8eaa10a0"],
                      },
                      globalSwatchId: "--_colors---white",
                      rValue: 255,
                      bValue: 255,
                  ...
                  },
                  {
                    ...
                    config: {
                      ...
                      target: {
                        useEventTarget: "CHILDREN",
                        selector: ".contact-single-info-text",
                        selectorGuids: ["ce294e74-0716-8816-8326-297865f1d3a9"],
                      },
                      xValue: 0,
                      xUnit: "px",
                      yUnit: "PX",
                  ...
                  },
                  {
                    ...
                    config: {
                      ...
                      target: {
                        useEventTarget: "CHILDREN",
                        selector: ".contact-single-info-icon-wrap",
                        selectorGuids: ["3edd2922-d674-230b-66b2-2ad084937710"],
                      },
                      xValue: 0,
                      xUnit: "px",
                      yUnit: "PX",
                ...
                actionItems: [
                  {
                    ...
                    config: {
                      ...
                      globalSwatchId: "--_colors---white-smoke",
                      rValue: 244,
                      bValue: 244,
                      gValue: 244,
                      aValue: 1,
            ...
            useFirstGroupAsInitialState: !0,
            createdOn: 0x19aaeac62a9,
          },
          "a-25": {
            id: "a-25",
            title: "Contact Info Item Hover Out",
            actionItemGroups: [
              {
                actionItems: [
                  {
                ...
                actionItems: [
                  {
                    ...
                    config: {
                      ...
                      target: {
                        ...
                        selectorGuids: ["321bedb7-79c0-eba6-46dc-9bcc631ea2e1"],
                      },
                      globalSwatchId: "--_colors---white",
                      rValue: 255,
                      bValue: 255,
                  ...
                  },
                  {
                    ...
                    config: {
                      ...
                      target: {
                        useEventTarget: "CHILDREN",
                        selector: ".service-item-text",
                        selectorGuids: ["3237afba-17d2-8c42-f0f9-c21991d1cce3"],
                      },
                      xValue: 0,
                      xUnit: "px",
                      yUnit: "PX",
                  ...
                  },
                  {
                    ...
                    config: {
                      ...
                      target: {
                        useEventTarget: "CHILDREN",
                        selector: ".service-item-icon",
                        selectorGuids: ["189b02e6-d1a1-b57b-4a1f-551abc3cec95"],
                      },
                      xValue: 0,
                      xUnit: "px",
                      yUnit: "PX",
                ...
                actionItems: [
                  {
                    ...
                    config: {
                      ...
                      target: {
                        ...
                        selectorGuids: ["6a25a10c-6862-03fa-2729-75fc94ea9260"],
                      },
                      xValue: 1,
                      yValue: 1,
                      locked: !0,
                ...
                actionItems: [
                  {
                    ...
                    config: {
                      ...
                      target: {
                        useEventTarget: "CHILDREN",
                        selector: ".primary-button-icon-wrap",
                        selectorGuids: ["47a4f43a-5ced-77f5-85c6-ee70cc516ade"],
                      },
                      widthValue: 48,
                      widthUnit: "px",
                      heightUnit: "PX",
                  ...
                  },
                  {
                    ...
                    config: {
                      ...
                      target: {
                        useEventTarget: "CHILDREN",
                        selector: ".primary-button-text-two",
                        selectorGuids: ["47a4f43a-5ced-77f5-85c6-ee70cc516ae1"],
                      },
                      widthValue: 100,
                      widthUnit: "%",
                      heightUnit: "PX",
                  ...
                  },
                  {
                    ...
                    config: {
                      ...
                      target: {
                        useEventTarget: "CHILDREN",
                        selector: ".primary-button-text-one",
                        selectorGuids: ["47a4f43a-5ced-77f5-85c6-ee70cc516adf"],
                      },
                      value: 0,
                      unit: "",
                    },
          ...
          "a-32": {
            ...
            useFirstGroupAsInitialState: !1,
            createdOn: 0x199292a4ac1,
          },
          "a-33": {
            id: "a-33",
            title: "Social Media Link Hover In",
            actionItemGroups: [
              {
                actionItems: [
                  {
                    ...
                    config: {
                      ...
                      target: {
                        useEventTarget: "CHILDREN",
                        selector: ".line-one",
                        selectorGuids: ["27ecbbed-d5d0-9885-1436-5f0be5523027"],
                      },
                      widthValue: 0,
                      widthUnit: "%",
                      heightUnit: "PX",
                  ...
                  },
                  {
                    ...
                    config: {
                      ...
                      target: {
                        useEventTarget: "CHILDREN",
                        selector: ".social-media-link-icon",
                        selectorGuids: ["6e734020-8c65-1765-4f2f-2fa374bd524a"],
                      },
                      zValue: 0,
                      xUnit: "DEG",
                      yUnit: "DEG",
            ...
            useFirstGroupAsInitialState: !0,
            createdOn: 0x19abaa79b84,
          },
          "a-34": {
            id: "a-34",
            title: "Social Media Link Hover Out",
            actionItemGroups: [
              {
                actionItems: [
                  {
            ...
            useFirstGroupAsInitialState: !1,
            createdOn: 0x19abaa842d4,
          },
          "a-35": {
            id: "a-35",
            title: "Process Card Scroll",
            continuousParameterGroups: [
              {
                id: "a-35-p",
                type: "SCROLL_PROGRESS",
                    ...
                    actionItems: [
                      {
                        ...
                        config: {
                          ...
                          duration: 500,
                          target: {
                            selector: ".process-single-card-wrap.one",
                            selectorGuids: [
                              "d86253f7-8da9-2160-74db-2c0b8ed783aa",
                              "01e37ddd-189f-1c7c-1d53-ee0b8cc69ff5",
                            ],
                          },
                          xValue: 150,
                          yValue: 100,
                      ...
                      },
                      {
                        ...
                        config: {
                          ...
                          duration: 500,
                          target: {
                            selector: ".process-single-card-wrap.two",
                            selectorGuids: [
                              "d86253f7-8da9-2160-74db-2c0b8ed783aa",
                              "0180976b-b178-3f17-3289-e8fbd7162866",
                            ],
                          },
                          xValue: 50,
                          yValue: 100,
                      ...
                      },
                      {
                        ...
                        config: {
                          ...
                          duration: 500,
                          target: {
                            selector: ".process-single-card-wrap.three",
                            selectorGuids: [
                              "d86253f7-8da9-2160-74db-2c0b8ed783aa",
                              "8ae96ce4-3cf2-be98-0254-d72db340e1c3",
                            ],
                          },
                          xValue: -50,
                          yValue: 100,
                      ...
                      },
                      {
                        ...
                        config: {
                          ...
                          duration: 500,
                          target: {
                            selector: ".process-single-card-wrap.four",
                            selectorGuids: [
                              "d86253f7-8da9-2160-74db-2c0b8ed783aa",
                              "1104c5b6-eb51-1587-638f-f6fef7001b1b",
                            ],
                          },
                          xValue: -150,
                          yValue: 100,
                ...
                actionItems: [
                  {
                    ...
                    config: {
                      ...
                      duration: 16e3,
                      target: {
                        selector: ".name-ticker-wrap",
                        selectorGuids: ["0db2c9c8-81de-8a47-2dea-c385e9a17c22"],
                      },
                      xValue: -100,
                      xUnit: "%",
                      yUnit: "PX",
